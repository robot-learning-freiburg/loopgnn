...
from loopgnn.data.graph_data_siamese import GraphDatasetSiamese
...
class LoopGNNTrainer:
    ...
    def __init__(self, params: DictConfig):
        ...
        self.train_graphdata = GraphDatasetSiamese(self.params, self.train_scenes, split='train')
        ...
        self.val_graphdata = GraphDatasetSiamese(self.params, self.test_scenes, split='test')
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            if epoch > -1 and self.params.gnn.save_checkpoint and self.params.main.wandb:
